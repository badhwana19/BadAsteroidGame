...
function oTitleUD()
{
	...
	c.fillText("दुष्ट क्षुद्रग्रहक्रीडा", GAME_WIDTH_HALF, GAME_HEIGHT_HALF - 60);
	c.fillStyle = TEXT_COLOR_GREEN;
	c.fillText("प्ले कर्तुं दब्ध्वा", GAME_WIDTH_HALF, GAME_HEIGHT_HALF + 20);
...
function oEndUD()
{
	...
	c.font = "20px Courier";
	c.fillStyle = TEXT_COLOR_WHITE;
	c.fillText("खेलं समाप्तम्", GAME_WIDTH_HALF, GAME_HEIGHT_HALF - 60);
	c.fillStyle = TEXT_COLOR_GREEN;
	c.fillText("अंक: " + Sanscript.t(String(score),'iast', 'devanagari'), GAME_WIDTH_HALF, GAME_HEIGHT_HALF - 30);
	c.fillText("उच्च अंक: " + Sanscript.t(String(highScore),'iast', 'devanagari'), GAME_WIDTH_HALF, GAME_HEIGHT_HALF - 12);
	c.fillText("पुनः प्रविश्य दब्ध्वा", GAME_WIDTH_HALF, GAME_HEIGHT_HALF + 20);
...
function gmLoop()
{
	...
	c.font = "16px Courier";
	c.textAlign = "left";
	c.fillText("अंक: " + Sanscript.t(String(score),'iast', 'devanagari'), 6, 32);
	c.fillText("उच्च अंक: " + Sanscript.t(String(highScore),'iast', 'devanagari'), 6, 48);
}